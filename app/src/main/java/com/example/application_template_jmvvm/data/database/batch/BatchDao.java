...
public interface BatchDao {
    ...
    @Query("UPDATE " + DatabaseInfo.BATCHTABLE + " SET " + BatchCol.col_ulSTN + " = " + BatchCol.col_ulSTN + " + 1 WHERE ROWID = (SELECT ROWID FROM " + DatabaseInfo.BATCHTABLE + " LIMIT 1)")
    void updateSTN();
    ...
    @Query("UPDATE " + DatabaseInfo.BATCHTABLE + " SET " + BatchCol.col_ulGUP_SN + " = 1, " + BatchCol.col_ulSTN + " = 0, " + BatchCol.col_batchNo + " = " + BatchCol.col_batchNo + "+ 1 WHERE ROWID = (SELECT ROWID FROM " + DatabaseInfo.BATCHTABLE + " LIMIT 1)")
    void updateBatchNo();
    ...
    @Query("SELECT " + BatchCol.col_ulSTN + " FROM " + DatabaseInfo.BATCHTABLE + " LIMIT 1")
    int getSTN();
